...
if __name__ == '__main__':
    ...
    print('---------------------------------------------------------------')
    # 示例调用
    file_path = r"C:\Users\juntaox\Desktop\工作\3.浦东新区四大重点经济圈发展分析\电量汇总结果.xlsx"  # 替换为实际的文件路径
    sheet_names = ['4、东方枢纽-祝桥']
    # sheet_names = ['1、小陆家嘴', '3、国际度假区-川沙', '4、东方枢纽-祝桥']
    results = {}
    ...
    output_file_path = r"C:\Users\juntaox\Desktop\电量预测结果_亿单位.xlsx"  # 替换为你的输出路径
