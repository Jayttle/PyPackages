...
def analysis(df: pd.DataFrame, category: str) -> pd.DataFrame:
    voltages = ['交流110kV', '交流35kV', '交流10kV', '低压']
    results = []
...
if __name__ == '__main__':
    # 读取数据
    print('---------------------------------------------------------------')
    file_path = r"E:\vscode_proj\浦东四大重点区域用户清单.xlsx"
    json_file = r'E:\vscode_proj\川沙行业分类.json'
    sheet_name = '3、国际度假区-川沙'  # 指定工作表名称 1、小陆家嘴 3、国际度假区-川沙
