...
class MonthlyReportolution:
    ...
    def __str__(self) -> str:
        ...
        result = (
            f"\n2024年{str_month}月新增单独立户充电站{self.total_num}个，新增容量{self.total_capacity}万千瓦。截至2024年8月，浦东单独立户充电站{self.total_num_2}个，容量{self.total_capacity_2}万千瓦。\n"
...
if __name__ == '__main__':
    # 统计 7月内居民用户个数
    analysis_month = '2024-08' # 7月份月报
    file_path = r"C:\Users\juntaox\Desktop\工作待办\2.浦东月报\浦东月报-数据需求清单 - 202408.xlsx"  # 数据需求清单
    file_path2 = r"C:\Users\juntaox\Desktop\工作待办\2.浦东月报\浦东自营充电站充电量统计-202408.xlsx" #充电站充电量统计 
    docx_path = r"C:\Users\juntaox\Desktop\工作待办\2.浦东月报\联联数据需求2024年8月.docx" # 联联数据
    ...
    current_data_pure_electric = 206200

    # 上一月数据
    last_month_data_plug_in_hybrid = 96400
    last_month_data_pure_electric = 204700
