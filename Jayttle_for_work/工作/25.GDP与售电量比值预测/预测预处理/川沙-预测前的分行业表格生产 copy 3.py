...
if __name__ == '__main__':
    # 读取数据
    print('---------------------------------------------------------------')
    file_path = r"C:\Users\juntaox\Desktop\工作\25.GDP与售电量比值预测\行业预测\原始材料\川沙.xlsx"
    df = pd.read_excel(file_path)
    json_file = r"E:\OneDrive\PyPackages\Jayttle_for_work\3.浦东新区四大重点经济圈\川沙行业分类.json"
    out_put_file = r"C:\Users\juntaox\Desktop\工作\25.GDP与售电量比值预测\行业预测\川沙行业.xlsx"
