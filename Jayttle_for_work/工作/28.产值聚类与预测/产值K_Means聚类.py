...
if __name__ == '__main__':
    ...
    # 绘制散点图和折线图(final_df)
    # 聚类分析
    final_df_standardized, kmeans = 聚类分析(final_df, k=2)  # 假设聚为2类
    ...
    # 确保新的索引长度和 final_df 的行数相同
    if len(new_index) == len(final_df_standardized):
    ...
    with pd.ExcelWriter(r"C:\Users\juntaox\Desktop\工作\28.产值聚类和预测\药业-现价产值.xlsx") as writer:
