...
def main() -> None:
    ...
    # 文件路径
    file_path = r"C:\Users\juntaox\Desktop\工作待办\浦东月报\浦东自营充电站充电量统计-202408.xlsx"
    ...
    df_filtered_2024 = df[(df['月份'] >= '202401') & (df['月份'] <= '202408')]
    
    # 过滤月份范围 202301 到 202308
    df_filtered_2023 = df[(df['月份'] >= '202301') & (df['月份'] <= '202308')]
...
def main2() -> None:
    ...
    df_filtered_2024 = df[(df['月份'] == '202408')]
    
    # 过滤月份范围 202301 到 202307
    df_filtered_2023 = df[(df['月份'] == '202308')]
