...
class MonthlyReportolution:
    ...
    def total_Resident_data(self) -> None:
        ...
        column_name_current_1 = '202408电量'
        column_name_previous_1 = '202308电量'
        ...
        column_name_current_2 = '202401-08电量'
        column_name_previous_2 = '202301-08电量'
...
if __name__ == '__main__':
    # 统计 7月内居民用户个数
    analysis_month = '2024-08' # 8月份月报
    file_path = r"C:\Users\juntaox\Desktop\浦东月报-数据需求清单 - 202408.xlsx"  # 替换为你的 Excel 文件路径
    arg_1tox_newAdd = 578079  # 上海市 截止充电桩总量
    arg_x_newAdd = 9568  # 上海市 充电桩某月新增
    arg_1tox_monUser_kwh = 93746.7485  # 上海市1-x月居民用电量总量 万kwh
    arg_x_monUser_kwh = 13266.0267   # 上海市第x月居民用电量总量 万kwh
