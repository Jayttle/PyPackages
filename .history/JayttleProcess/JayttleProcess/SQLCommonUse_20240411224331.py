...
def visualize_gantt_chart(start_time, end_time, data_intervals, record_intervals):
    # 计算甘特图的时间范围
...
record_intervals = [
    (datetime(2023, 4, 13, 16, 4, 40, 985000), datetime(2024, 4, 11, 13, 5, 16, 701000))
]

# 可视化甘特图
visualize_gantt_chart(
    datetime(2023, 4, 13, 16, 4, 40, 985000),
    datetime(2024, 4, 11, 13, 5, 16, 701000),
    data_intervals,
    record_intervals
)