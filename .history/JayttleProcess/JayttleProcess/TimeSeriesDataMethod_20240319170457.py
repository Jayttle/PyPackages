...
# 欧氏距离
euclidean_distance = calculate_distance(ts1, ts2)
print("欧氏距离:", euclidean_distance)

# 皮尔逊相关系数
pearson_correlation = calculate_correlation(ts1, ts2, 'pearson')
print("皮尔逊相关系数:", pearson_correlation)

# 斯皮尔曼等级相关系数
spearman_correlation = calculate_correlation(ts1, ts2, 'spearman')
