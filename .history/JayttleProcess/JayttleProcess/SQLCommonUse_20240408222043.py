...
def insert_data(*args):
    if len(args) == 0:
        ...
        print("Data inserted successfully with parameters!")
    else:
        raise ValueError("Invalid arguments for insert_data")
