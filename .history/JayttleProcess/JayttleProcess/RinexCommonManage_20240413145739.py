...
class MergeFiles:
    ...
    def merge_files(files: list[RinexFileInfo], merge_path: str, rewrite: bool = False) -> bool:
        ...
        process = subprocess.Popen(["D:\Program Files (x86)\Software\OneDrive\C#\windows_C#\Cableway.Net7\Cableway.Download\Rinex\gfzrnx_2.1.0_win64.exe", arguments], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
        process.communicate()
        sleep(0.1)
