...
def calculate_weekly_missing_percentage(
    ...
    # Initialize list to store weekly missing percentage
    weekly_missing_percentage = []

    # Iterate over each week
    for week_index in range(total_weeks):
        # Define week start and end
        ...
        # Calculate missing seconds in the week
        ...
        # Calculate missing percentage for the week
