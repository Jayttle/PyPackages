...
def write_rinex_files_to_txt(rinex_files_info: list[RinexFileInfo], 
    ...
    with open(output_file_path, 'w') as output_file:
        for rinex_file_info in rinex_files_info:
            if rinex_file_info.marker_name == marker_name and rinex_file_info.start_gps_time.date() in dates:
...
for item in ["R031", "R032", "R051", "R052", "R071", "R072", "R081", "R082"]:
    ...
    marker_name = item
    write_rinex_files_to_txt(rinex_files_info, marker_name, dates_with_specific_count, output_file_path)