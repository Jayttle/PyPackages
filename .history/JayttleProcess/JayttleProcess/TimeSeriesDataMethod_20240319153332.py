...
# 计算统计指标
values = [data_point.value for data_point in ts_data]

mean = TimeSeriesData.calculate_mean(values)
print("Mean:", mean)

median = TimeSeriesData.calculate_median(values)
print("Median:", median)

variance = TimeSeriesData.calculate_variance(values)
print("Variance:", variance)

std_deviation = TimeSeriesData.calculate_standard_deviation(values)
