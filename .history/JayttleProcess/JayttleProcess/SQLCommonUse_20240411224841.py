...
def visualize_missing_data(start_time: datetime, end_time: datetime, missing_intervals):
    ...
    # Plot the rectangle box plot
    plt.figure(figsize=(10, 6))
    plt.bar(range(total_weeks), missing_percentage, color='blue')
    plt.xlabel('Week')
    plt.ylabel('Percentage of Missing Time')
    plt.title('Rectangle Box Plot for Missing Data')
    plt.grid(True)
    plt.show()
