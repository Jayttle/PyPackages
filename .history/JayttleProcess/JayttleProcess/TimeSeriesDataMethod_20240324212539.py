...
def evaluate_predictions(ridge_pred, lasso_pred, elastic_pred, polynomial_pred, data,degree):
    ...
    # 计算 AIC 和 BIC
    aic_ridge = calculate_AIC(data, ridge_mse, num_parameters_ridge)
    bic_ridge = calculate_BIC(data, ridge_mse, num_parameters_ridge)
    aic_lasso = calculate_AIC(data, lasso_mse, num_parameters_lasso)
    bic_lasso = calculate_BIC(data, lasso_mse, num_parameters_lasso)
    aic_elastic = calculate_AIC(data, elastic_mse, num_parameters_elastic)
    bic_elastic = calculate_BIC(data, elastic_mse, num_parameters_elastic)
    aic_polynomial = calculate_AIC(data, polynomial_mse, num_parameters_polynomial)
    bic_polynomial = calculate_BIC(data, polynomial_mse, num_parameters_polynomial)
...
#使用函数进行评估
evaluate_predictions(ridge_pred, lasso_pred,elastic_pred,polynomial_pred, data,degree=10)
