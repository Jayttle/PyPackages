...
def fit_and_concatenate_trend_lines(segmented_data: List[List[TimeSeriesData]], degree: int) -> np.ndarray:
    """拟合多项式趋势线并将所有拟合的趋势线连接起来"""
    trend_lines = []

    for segment_data in segmented_data:
        trend_line = fit_Ridge_polynomial_trend(segment_data, degree)
        trend_lines.append(trend_line)
