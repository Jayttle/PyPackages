...
def calculate_AIC(data, y_pred, degree):
    ...
    mse = root_mean_squared_error(get_y_values(data), y_pred)
...
find_Lasso_best_degree(data)
find_best_Lasso_degree_using_BIC(data)
find_best_Lasso_degree_using_AIC(data)
y_pred=fit_Lasso_polynomial_trend(data)
