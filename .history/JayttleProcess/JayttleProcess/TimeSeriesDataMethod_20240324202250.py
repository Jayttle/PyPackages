...
def find_best_degree(data):
    ...
    for degree in range(1, 11):  # 假设循环从1到10的范围
        # 创建 Polynomial 特征转换器
...
# 使用示例
best_degree, best_r_squared = find_best_degree(data)
print("最佳Degree:", best_degree)
print("对应的最佳R方值:", best_r_squared)
