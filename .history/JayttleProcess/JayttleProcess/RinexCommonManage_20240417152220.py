...
def create_marker_name_excel(marker_name_files_per_day_1h: dict[str, dict], file_path: str = "marker_name_statistics.xlsx") -> None:
    # Import required classes from openpyxl
    from openpyxl import Workbook
    from openpyxl.styles import Alignment
    ...
    # 写入数据
    for idx, (date_str, files_per_day) in enumerate(marker_name_files_per_day_1h.items(), start=2):
        # Convert date string back to date object for formatting
