...
# 使用 FTPConfig 对象调用函数
success = download_files_from_ftp(ftp_config, remote_folder='tower3', files_to_download=['R03100000_R_20230621748_12M_01S_MO.crx.Z', 'R03100000_R_20230621748_12M_MN.rnx.Z'], local_save_path=r'D:\Ropeway\GNSS\FTP')
if success:
    print("文件下载成功！")
else:
    print("文件下载失败。")