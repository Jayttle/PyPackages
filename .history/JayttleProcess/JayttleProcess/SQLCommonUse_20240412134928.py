...
# 计算missing_intervals总共的秒数
total_missing_seconds = sum(end - start for start, end, _ in missing_intervals)

# 计算missing_intervals总共的秒数与一周的秒数的比例
missing_to_week_ratio = total_missing_seconds / (total_weeks * seconds_in_week)

print("Total Weeks:", total_weeks)
print("Seconds in a Week:", seconds_in_week)
print("Total Missing Seconds:", total_missing_seconds)
print("Missing to Week Ratio:", missing_to_week_ratio)