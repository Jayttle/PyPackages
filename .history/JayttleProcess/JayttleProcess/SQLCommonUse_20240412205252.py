...
accelerometer_min_time, accelerometer_max_time = get_min_max_time('accelerometer')
print(accelerometer_min_time)
print(accelerometer_max_time)
# 计算SQL_accelerometer和SQL_tiltmeter的每日数据存有率
daily_data_availability_accelerometer = calculate_daily_data_availability(accelerometer_min_time, accelerometer_max_time, missing_intervals_accelerometer)
daily_data_availability_tiltmeter = calculate_daily_data_availability(min_time, max_time, missing_intervals_tiltmeter)

for key,value in daily_data_availability_accelerometer.items():
    print(f'{key}\t{value}')
