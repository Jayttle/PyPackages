...
@log_function_call
def count_time_differences(tableName, startTime, stopTime):
    # 构造查询 SQL 语句
    sql_statement = f"SELECT TIMESTAMPDIFF(SECOND, startTime, stopTime) AS diff FROM {tableName} WHERE startTime >= %s AND stopTime <= %s"
