...
data = {
    'Data_A': [
        (datetime.datetime(2024, 4, 1), datetime.datetime(2024, 4, 3)),
        (datetime.datetime(2024, 4, 5), datetime.datetime(2024, 4, 7)),
        (datetime.datetime(2024, 4, 10), datetime.datetime(2024, 4, 13)),
    ],
    'Data_B': [
        (datetime.datetime(2024, 4, 2), datetime.datetime(2024, 4, 4)),
        (datetime.datetime(2024, 4, 8), datetime.datetime(2024, 4, 9)),
        (datetime.datetime(2024, 4, 11), datetime.datetime(2024, 4, 12)),
    ],
    'Data_C': [
        (datetime.datetime(2024, 4, 3), datetime.datetime(2024, 4, 5)),
        (datetime.datetime(2024, 4, 9), datetime.datetime(2024, 4, 10)),
        (datetime.datetime(2024, 4, 14), datetime.datetime(2024, 4, 15)),
    ],
    # 更多数据...
}
...
for idx, (data_name, time_ranges) in enumerate(data.items(), start=1):
