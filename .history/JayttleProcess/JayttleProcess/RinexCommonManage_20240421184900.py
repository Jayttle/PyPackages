...
if to_process_rnx_file:
    first_rinex_info = to_process_rnx_file[0][0]  # 获取第一个 RinexFileInfo
    print(first_rinex_info.file_name)
else:
    print("to_process_rnx_file 中没有 RinexFileInfo 对象")