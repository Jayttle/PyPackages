...
def evaluate_predictions(ridge_pred, lasso_pred, data):
    """评估 Ridge 和 Lasso 预测结果的拟合效果"""
    ...
    if ridge_mse < lasso_mse:
        print("Ridge回归模型的拟合效果更好")
    elif lasso_mse < ridge_mse:
        print("Lasso回归模型的拟合效果更好")
    else:
        print("两种模型的拟合效果相似")
...
y_pred=fit_ElasticNet_polynomial_trend(data)
plot_polynomial_tread(data,y_pred)
# 使用函数进行评估
evaluate_predictions(ridge_pred, lasso_pred, data)
# 使用示例
