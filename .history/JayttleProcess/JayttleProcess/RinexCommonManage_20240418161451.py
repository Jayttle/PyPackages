...
# 将数据写入表格
for date, file_counts in sorted_files_per_day.items():
    row = [date] + [file_counts.get(marker, 0) for marker in header[1:]]
    ws.append(row)

# 保存Excel文件
output_excel_path = "D:\\Ropeway\\GNSS\\files_per_day.xlsx"
