...
class TimeSeriesData:
    ...
    def kendall_change_point_detection(self):
        ...
        Exp_value2 = [0]
        Var_value2 = [0]
        input_data_t = list(reversed(self.value))
...
# 创建TimeSeriesData实例
data_points = [
    TimeSeriesData(12, datetime(2022, 1, 1)),
    TimeSeriesData(12, datetime(2022, 1, 2)),
    TimeSeriesData(12, datetime(2022, 1, 3)),
    TimeSeriesData(222, datetime(2022, 1, 4)),
    TimeSeriesData(12, datetime(2022, 1, 5)),
    TimeSeriesData(12, datetime(2022, 1, 6)),
    TimeSeriesData(12, datetime(2022, 1, 7)),
    # ... 添加更多数据点
]
