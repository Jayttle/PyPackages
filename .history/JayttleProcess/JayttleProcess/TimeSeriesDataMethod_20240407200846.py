...
# 执行聚类分析
num_clusters = 3
cluster_labels = cluster_analysis_AgglomerativeClustering(complete_trend_line, num_clusters)
silhouette, davies_bouldin, calinski_harabasz = cluster_cluster_labels_with_score(complete_trend_line, num_clusters)
