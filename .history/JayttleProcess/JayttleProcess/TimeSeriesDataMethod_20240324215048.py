...
def plot_denoised_signal(signal, denoised_signal):
    plt.figure(figsize=(10, 5))
...
denoised_signal=wavelet_denoising(data)
plot_TimeSeriesData_Compare(data,denoised_signal)
# window_size = 10
# smoothed_data = smooth_noise([data_point.value for data_point in data], window_size)

# num_bins = 5
# bins = equal_depth_binning(data, num_bins)

# smoothed_bins = mean_smoothing(bins)
# # 调用可视化函数
# plot_smoothed_data_and_bins(data, smoothed_data, bins, smoothed_bins)
