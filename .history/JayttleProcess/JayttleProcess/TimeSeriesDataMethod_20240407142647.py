...
def detect_cusum_diff_threshold(cusum_values: List[float], threshold):
    """
    ...
    return change_points
def detect_cusum_window(cusum_values: List[float], threshold, window_size):
    """
    滑动窗口来检测连续的CUSUM值
...
def calculate_rolling_std(data: List[TimeSeriesData], window_size):
    """滚动标准差来检测波动性的变动"""
