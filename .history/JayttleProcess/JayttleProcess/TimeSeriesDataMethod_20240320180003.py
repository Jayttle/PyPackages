...
for i, imf in enumerate(imfs):
    ...
    # 输出每个 IMF 的频谱能量
    print(f"IMF {i+1} 的频谱能量：{spectral_energy}")
    peak_frequency = calculate_peak_frequency(spectral_energy)
    print(f"IMF {i + 1} 的峰值频率：{peak_frequency} Hz")
    calculate_primary_frequency_range(spectral_energy)