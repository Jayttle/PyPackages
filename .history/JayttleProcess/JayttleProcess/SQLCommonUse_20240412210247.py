...
# 示例用法
daily_missing_percentage = calculate_daily_data_availability(min_time, max_time, missing_intervals)
for key,value in daily_missing_percentage.items():
    print(f'{key}\t{value}')
...
# daily_data_availability_tiltmeter = calculate_daily_data_availability(tiltmeter_min_time, tiltmeter_max_time, missing_intervals_tiltmeter)
