...
def cluster_analysis_with_guss_in_GridSearchCV(complete_trend_line: np.ndarray) -> np.ndarray:
    """使用高斯混合聚类算法对趋势线进行聚类分析"""
    # Reshape the trend line array to be a column vector
    trend_line_vector = complete_trend_line.reshape(-1, 1)
...
num_clusters = 3
cluster_labels = cluster_analysis_with_guss(value_np)
