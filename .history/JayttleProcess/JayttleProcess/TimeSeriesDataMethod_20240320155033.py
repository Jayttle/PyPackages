...
# 打印频域特征示例
print("Frequencies:", frequency_features['frequency'])
print("Magnitude Spectrum:", frequency_features['magnitude_spectrum'])
print("Phase Spectrum:", frequency_features['phase_spectrum'])
