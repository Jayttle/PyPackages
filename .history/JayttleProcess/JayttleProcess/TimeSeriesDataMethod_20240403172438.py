...
class TimeSeriesData:
    def __init__(self, value, datetime):
        self.value = value
        self.datetime = datetime.strptime(datetime.strip(), "%Y-%m-%d %H:%M:%S")
...
def fit_trend_line(data, window):
    # 使用线性回归拟合趋势线
...
def adaptive_trend_fitting(data, initial_threshold):
    ...
    while n < len(data):
        ...
        # 拟合趋势线并计算相关系数
        trend_line = fit_trend_line(data, r)
