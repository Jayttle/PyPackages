...
# 提取缺失数据时间段的起始时间和持续时间
start_times = [start for start, _, _ in missing_data]
durations = [duration for _, _, duration in missing_data]

# 绘制可视化图表
plt.figure(figsize=(10, 6))
plt.plot(start_times, durations, 'bo', markersize=8)
plt.xlabel('Start Time')
plt.ylabel('Duration (seconds)')
plt.title('Missing Data Intervals')
