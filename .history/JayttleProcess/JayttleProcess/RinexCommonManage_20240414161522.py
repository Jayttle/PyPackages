...
def proj_merge_rnx():
    ...
    # 打印组 "12-15" 内的 RinexFileInfo 的 file_info
    group_12_15: list[RinexFileInfo] = grouped_o_files.get("12-15", [])
    group_16_19: list[RinexFileInfo] = grouped_o_files.get("16-19", [])
    group_20_23: list[RinexFileInfo] = grouped_o_files.get("20-23", [])

    MergeFiles.merge_files(group_12_15, merge_path)
    MergeFiles.merge_files(group_16_19, merge_path)
    MergeFiles.merge_files(group_20_23, merge_path)
